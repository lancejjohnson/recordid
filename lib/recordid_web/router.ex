defmodule RecordidWeb.Router do
  ...
  scope "/", RecordidWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{RecordidWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", RecordidWeb do
    # NOTE: Guards the normal HTTP request/response
    pipe_through [:browser, :require_authenticated_user]

    # NOTE: Guards the upgraded connection to a websocket
  ...
  scope "/", RecordidWeb do
    ...
    live_session :current_user,
      on_mount: [{RecordidWeb.UserAuth, :mount_current_user}] do
